...
include $(PREBUILT_SHARED_LIBRARY)
# Creating prebuilt for dependency: monkecomputer - version: 1.2.0
include $(CLEAR_VARS)
...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -I'extern/libil2cpp/il2cpp/libil2cpp' -isystem 'extern' -I'extern/monkecodegen/include' -DID='"MonkeMapLoader"' -DVERSION='"1.0.6"' -I'./shared' -I'./extern' -Wno-inaccessible-base -Wno-invalid-offsetof
