...
# Creating prebuilt for dependency: monkecomputer - version: 1.3.3
include $(CLEAR_VARS)
...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -I'extern/libil2cpp/il2cpp/libil2cpp' -isystem 'extern' -I'extern/monkecodegen/include' -DID='"MonkeMapLoader"' -DVERSION='"1.0.2"' -I'./shared' -I'./extern' -Wno-inaccessible-base -Wno-invalid-offsetof
